...
(\citeproc{ref-langleyStockAssessmentYellowfin2015}{Langley 2015}). The
...
(\citeproc{ref-fuPreliminaryIndianOcean2018}{Fu et al. 2018b}). Recent
...
catch scenarios (\citeproc{ref-fuIndianOceanYellowfin2018}{Fu et al.
2018a}). It was later discovered that the problem was mostly related to
...
(\citeproc{ref-merinoStateDevelopmentWorkplan2019}{Merino et al. 2019};
\citeproc{ref-merinoIndianOceanYellowfin2020}{Merino 2020}). An external
...
(\citeproc{ref-froeseFishBase2024}{Froese and Pauly 2024}). Yellowfin
...
2013}) and recruitment to the purse seine fishery occurs predominantly
...
(\citeproc{ref-greweGeneticPopulationConnectivity2020}{Grewe et al.
2020}). These studies generally support the potential presence of
...
\bibitem[\citeproctext]{ref-fuIndianOceanYellowfin2018}
...
\bibitem[\citeproctext]{ref-merinoIndianOceanYellowfin2020}
Merino, Gorka. 2020. {``Indian {Ocean} Yellowfin Workplan
(2019-2020).''} IOTC-2020-WPTT22(AS)-INF01. Indian Ocean Tuna Comission.

\bibitem[\citeproctext]{ref-merinoStateDevelopmentWorkplan2019}
