...
2013}). SS3 is conceptually similar to MFCL, and the two platforms have
...
al. 2019}). Further analyses were conducted in 2020 to refine the
...
in 2023 (\citeproc{ref-maunderIndependentReviewRecent2023}{Maunder et
al. 2023}), which provided a set of recommendations for the next
...
2013}). Still, an updated study suggests that it might be at a larger
size (\(\sim\) 101 cm)
...
\item
  ...
  2013}). Length data have also been available from other fleets (e.g.,
...
\item
  ...
  dynamics. Hoyle (\citeproc{ref-hoyleReviewSizeData2021}{2021})
...
(\citeproc{ref-fuIndianOceanSkipjack2017}{2017}), a 100\% reporting rate
...
(\citeproc{ref-langleyStockAssessmentYellowfin2012}{Langley, Herrera,
and Million 2012}). Fu et al.
(\citeproc{ref-fuPreliminaryIndianOcean2018}{2018}) investigated a range
...
(\citeproc{ref-fuPreliminaryIndianOcean2018}{2018})). These exploratory
...
is unclear. Langley (\citeproc{ref-langleyUpdate2015Indian2016}{2016})
and Fu et al. (\citeproc{ref-fuPreliminaryIndianOcean2018}{2018})
...
seasonal effects (\citeproc{ref-fuPreliminaryIndianOcean2018}{Fu et al.
2018}). Therefore, environmental information was not included in the
2021 assessment.
...
(\citeproc{ref-lanEffectsClimateVariability2013}{Lan, Evans, and Lee
2013}; \citeproc{ref-lanInfluenceOceanographicClimatic2020}{Lan, Chang,
and Wu 2020}), as well as an impact of the ENSO on catch rates near the
Arabian Sea (\citeproc{ref-lanInfluenceOceanographicClimatic2020}{Lan,
Chang, and Wu 2020}). Langley, Fu, and Maunder
...
\includegraphics[width=5.02in,height=\textheight]{C:/Use/OneDrive - AZTI/General - IOTC_YFT_2024/output/figures/tag_nfish.png}
...
\includegraphics[width=3.34in,height=\textheight]{C:/Use/OneDrive - AZTI/General - IOTC_YFT_2024/output/figures/tag_map.png}
...
\includegraphics[width=5.02in,height=\textheight]{C:/Use/OneDrive - AZTI/General - IOTC_YFT_2024/output/figures/tag_nfish_area.png}
