...
A summary of the diagnostic analysis in shown in @tbl-diagnostics. Figure XXX show reasonable values of Mohn’s rho and do not show large retrospective patterns for absolute biomass. The hindcasting analysis for the CPUE in region 1 is shown in @fig-hind.
...
Estimates of stock status were calculated for the five candidate for a reference case model. The relevant benchmarks are shown for individual models in Table XXX. 
...
<!-- #| fig-align: center -->
<!-- knitr::include_graphics(file.path(shrpoint_path, 'output/figures', "Retro_model2.tiff"), rel_path = FALSE) -->
<!-- ``` -->
