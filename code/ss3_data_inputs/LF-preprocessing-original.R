...
# Read data:
Data = read.csv(file.path(shrpoint_path, 'data/raw',  "IOTC-2024-WPTT26(AS) - YFT - SF frequencies (original).csv"))
head(Data)
...
write.csv(out_data, file = file.path(shrpoint_path, 'data/processed', 'size_grid-original.csv'), row.names = FALSE)
