...
# Save SS catch input
write.csv(size_df, file = file.path(shrpoint_path, 'data/ss3_inputs', spat_config, 'size-original.csv'), row.names = FALSE)
...
# Save SS catch input
write.csv(size_df, file = file.path(shrpoint_path, 'data/ss3_inputs', spat_config, 'size-cwp55.csv'), row.names = FALSE)
