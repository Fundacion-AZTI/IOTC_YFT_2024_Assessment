...
Data79 =  rbind (cbind(subset(work_R1, !is.na(pr),select=c('yq','pr','yr','qtr')),AssessmentAreaName='1',NewAssessmentAreaName='1234'),
                 cbind(subset(work_R2, !is.na(pr),select=c('yq','pr','yr','qtr')),AssessmentAreaName='2',NewAssessmentAreaName='1234'),
                 cbind(subset(work_R3, !is.na(pr),select=c('yq','pr','yr','qtr')),AssessmentAreaName='3',NewAssessmentAreaName='1234'),
                 cbind(subset(work_R4, !is.na(pr),select=c('yq','pr','yr','qtr')),AssessmentAreaName='4',NewAssessmentAreaName='1234'))
...
Data79 =  rbind (cbind(subset(workcv_R1, !is.na(pr),select=c('yq','pr','yr','qtr','std')),AssessmentAreaName='1b',NewAssessmentAreaName='1234'),
                 cbind(subset(workcv_R2, !is.na(pr),select=c('yq','pr','yr','qtr','std')),AssessmentAreaName='2',NewAssessmentAreaName='1234'),
                 cbind(subset(workcv_R3, !is.na(pr),select=c('yq','pr','yr','qtr','std')),AssessmentAreaName='3',NewAssessmentAreaName='1234'),
                 cbind(subset(workcv_R4, !is.na(pr),select=c('yq','pr','yr','qtr','std')),AssessmentAreaName='4',NewAssessmentAreaName='1234'))
