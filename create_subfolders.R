...
dir.create(file.path(shrpoint_path, "data", "ss3_inputs", "2A_io"), showWarnings = FALSE, recursive = TRUE) 
dir.create(file.path(shrpoint_path, "data", "ss3_inputs", "1A_io"), showWarnings = FALSE, recursive = TRUE) 
...
dir.create(file.path(shrpoint_path, "models", "configurations", "2A_io"), showWarnings = FALSE, recursive = TRUE)
dir.create(file.path(shrpoint_path, "models", "configurations", "1A_io"), showWarnings = FALSE, recursive = TRUE)
